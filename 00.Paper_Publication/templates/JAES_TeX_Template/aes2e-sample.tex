...
% Page heads
\markboth{Aris Bezas}{Extract Sound Features by representing sound grains as particles
 }


% Title portion
\title{Extract sound features by representing sound grains as particles}

%Author Info.
\authorgroup{
\author{Aris Bezas},
\role{PhD student at Department of AudioVisual ARTS}
\email{(arisbezas@gmail.com)}
\affil{Ionian University, Corfu, Greece}
}
...
\bibitem{DEK1}
Preis D., ``Phase Distortion and Phase Equalization in Audio Signal Processing---A Tutorial Review,'' \textit{J. Audio Eng. Soc}, vol. 30, no. 11, pp. 774--794 (1982 Nov.).


\bibitem{DEK2}
Abel J. S. and Berners D. P., ``MUS424/EE367D: Signal Processing Techniques for Digital Audio Effects," Unpublished Course Notes, CCRMA, Stanford University, Stanford, CA (2005).

\bibitem{DEK3}
Roads C., ``Musical Sound Transformation by Convolution," in \textit{Proc. Int. Computer Music Conf.} (Tokyo, Japan, 1993), pp. 102--109.

\bibitem{DEK4}
Roads C., \textit{The Computer Music Tutorial}. MIT Press, Cambridge, MA, 1996.
